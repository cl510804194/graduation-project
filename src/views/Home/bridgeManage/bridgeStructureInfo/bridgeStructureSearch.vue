      ...
      <div class="search-box">
        <el-row :gutter="20">
          <el-col :span="6">
            <label for>
              构件编码
              <span>{{structForm.bridgeCode}}</span>
            </label>
          </el-col>
          <el-col :span="6">
            <label for>
...
export default {
  ...
  watch: {
    bridgeCodeP() {
      this.structForm.bridgeCode = this.bridgeCodeP;
    }
  },
  data() {
    return {
