<template>
  <div class="menu-manage-box">
    ...
    >
      ...
      <el-table-column prop="personId" label="创建人"></el-table-column>
      <el-table-column prop="organizationId" label="维修单位"></el-table-column>
      <el-table-column prop="recordMaintainWay" label="维修方式"></el-table-column>
      <el-table-column prop="recordMaintainMoney" label="维修实际金额"></el-table-column>
      <el-table-column prop="recordMaintainDetail" label="维修说明"></el-table-column>
...
export default {
  ...
  mounted: function() {
    ...
    axios
      .post(
        "http://bridge.vipgz1.idcfengye.com/api/maintain/getCheckMaintainRecord",
        {
          currentPage: 0,
          pageSize: 0
        }
