<template>
  <div class="menu-manage-box">
    ...
    >
      ...
      <el-table-column prop="abutmentStructureShape" label="桥台结构形式"></el-table-column>
      <el-table-column prop="pierStructureShape" label="桥墩结构形式"></el-table-column>
      <el-table-column prop="upsideStructureShape" label="上部结构形式"></el-table-column>
      <el-table-column prop="gradeRanking" label="总体评分等级"></el-table-column>
      <el-table-column prop="maintainRanking" label="保养、小修评分等级"></el-table-column>
      <el-table-column prop="cleanRanking" label="清洁等级"></el-table-column>
      <!-- <el-table-column prop="upsideStructureShape" label="上部结构形式"></el-table-column> -->
      <el-table-column prop="checkDetails" label="检查内容"></el-table-column>
      <el-table-column prop="recorder" label="记录人"></el-table-column>
      <el-table-column prop="recorder" label="记录人"></el-table-column>
...
export default {
  ...
  mounted: function() {
    var that = this;
    axios
      .post("http://bridge.vipgz1.idcfengye.com/api/check/getIntervalsRecord", {
        currentPage: 0,
        pageSize: 0
      })
      .then(function(response) {
