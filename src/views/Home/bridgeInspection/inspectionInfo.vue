<template>
  <div class="menu-manage-box">
    <div class="inspection-choose">
      <el-button class="inspect-button" @click="changeType()">添加巡检</el-button>
    </div>
    <el-table
...
import bridgeInfo from "../bridgeManage/bridgeInfo/bridgeInfo.vue";
